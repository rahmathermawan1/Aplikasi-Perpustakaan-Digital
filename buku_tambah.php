            ...
            <form method="post">
                <?php
                    if(isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,penulis,penerbit,tahun_terbit,deskripsi) values ('$nama','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi')");
                        ...
                        <select name="id_kategori" class="form-control">
                            <?php
                                ...
                                while($kategoribuku = mysqli_fetch_array($kat)) {
                                    ?>
                                    <option value="<?php echo $kategoribuku['id_kategori']; ?>"><?php echo $kategoribuku['nama_kategori']; ?></option>
                                    <?php
                                }
                            ?>
                        </select>

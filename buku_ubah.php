                        ...
                        <select name="id_kategori" class="form-control">
                            <?php
                                ...
                                while($kategoribuku = mysqli_fetch_array($kat)) {
                                    ?>
                                    <option <?php if($kategoribuku['id_kategori'] == $data['id_kategori']) echo 'selected'; ?> value="<?php echo $kategoribuku['id_kategori']; ?>"><?php echo $kategoribuku['nama_kategori']; ?></option>
                                    <?php
                                }
                            ?>
                        </select>
